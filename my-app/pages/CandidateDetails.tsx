    ...
    return(
        <div className='flex flex-col'>
            ...
            ml-[420px] mt-16">
                ...
                <h2 className='text-2xl'>For<br/>{title} Election</h2> 
                </div>
                ...
                ready to serve and represent your interests. I humbly ask for 
                your support and trust in this crucial time.<br/><br/>
                My vision for our community is rooted in unity, 
                progress, and inclusivity. I aim to foster an environment 
                where every voice is heard, where diversity is celebrated, 
                and where opportunities are accessible to all.<br/><br/>
                Together, we can shape a brighter future. Let's embark 
                on this journey together, hand in hand, and make our community a 
                beacon of hope and prosperity. Vote for a leader who will listen, 
                act, and deliver. Vote for a better tomorrow.
                <br/><br/><br/> Thank You!
                </p>
